...
namespace ActEditor.Core.Scripts.Effects {
	public class SilhouetteDistortionEffect : ImageProcessingEffect {
		...
		public SilhouetteDistortionEffect() : base("Silhouette distortion") {
		}
		...
		public override string InputGesture => "{Dialog.AnimationSilhouetteDistortion}";
