...
namespace ActEditor.Core.WPF.EditorControls {
	public static class ActIndexSelectorHelper {
		internal static void BuildDirectionalActionSelectorUI(List<FancyButton> fancyButtons, bool buttonsEnabled) {
		...
		internal static void BuildDirectionalActionSelectorUI(List<SimpleButton> fancyButtons, bool buttonsEnabled) {
			BitmapSource image = ApplicationManager.PreloadResourceImage("arrow.png");
			BitmapSource image2 = ApplicationManager.PreloadResourceImage("arrowoblique.png");
